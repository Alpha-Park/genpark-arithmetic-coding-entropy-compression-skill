...
[![GitHub stars](https://img.shields.io/github/stars/Alpha-Park/genpark-arithmetic-coding-entropy-compression-skill?style=social)](https://github.com/Alpha-Park/genpark-arithmetic-coding-entropy-compression-skill/stargazers)
...
```bash
git clone https://github.com/Alpha-Park/genpark-arithmetic-coding-entropy-compression-skill.git
